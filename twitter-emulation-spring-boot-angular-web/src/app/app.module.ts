...
const routes: Routes = [
  ...
  {path: 'account/tweets/:user', component: TweetsComponent, canActivate: [AuthenticationGuard]},
  {path: 'account/following/:user', component: FollowingComponent, canActivate: [AuthenticationGuard]},
  {path: 'account/followers/:user', component: FollowersComponent, canActivate: [AuthenticationGuard]},
