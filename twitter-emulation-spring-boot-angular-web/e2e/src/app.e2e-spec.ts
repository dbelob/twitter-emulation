...
describe('App', () => {
  ...
  it('should display home page', () => {
    mockServer.get("/api/authentication/user").thenReply(200, '{\"name\": \"jsmith\"}');
    mockServer.get("/api/account/statistics/jsmith").thenReply(200, '' +
      '{"username":"jsmith","description":"John Smith","tweetsCount":6,"followingCount":2,"followersCount":1,"follow":false}');
    mockServer.get("/api/tweet/timeline").thenReply(200,
  ...
  it('should switch to profile page and go back', () => {
    ...
    mockServer.get("/api/tweet/timeline").thenReply(200, '[' +
      ...
      ']');
    mockServer.get("/api/account/accounts/jsmith").thenReply(200, '{"username":"jsmith","password":"password","description":"John Smith"}');
