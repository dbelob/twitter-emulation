module.exports = function () {
    return { 
        accounts: [
            { id: 1, username: "jsmith", password: "password", description: "John Smith" },
            { id: 2, username: "jdoe", password: "password", description: "John Doe" },
            { id: 3, username: "rroe", password: "password", description: "Richard Roe" },
            { id: 4, username: "alone", password: "password", description: "John Alone" }
        ],
        tweets: [
            { id: 1, accountId: 1,
